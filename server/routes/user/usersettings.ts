  ...
  async (req, res, next) => {
    ...
    try {
      ...
      return res.status(200).json({
        ...
        watchlistSyncRemove: user.settings?.watchlistSyncRemove,
      });
    } catch (e) {
  ...
  try {
    ...
    if (!user.settings) {
      user.settings = new UserSettings({
        ...
        watchlistSyncRemove: req.body.watchlistSyncRemove,
      });
    } else {
      ...
      user.settings.watchlistSyncRemove = req.body.watchlistSyncRemove;
    }
    ...
    return res.status(200).json({
      ...
      watchlistSyncRemove: savedUser.settings?.watchlistSyncRemove,
